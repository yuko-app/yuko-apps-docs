...
<CardGroup cols={3}>
  ...
  <Card title="Install Shopjar" icon="download" href="https://apps.shopify.com/shopjar">
    Get [Shopjar Referral & Affiliate Marketing](https://apps.shopify.com/shopjar) from the Shopify App Store.
  </Card>
</CardGroup>
