...
<AccordionGroup>
  <Accordion title="Limit a flash-sale product to 2 per customer">
  ...
  <Accordion title="Wholesale MOQ: at least 10 units of any product">
  ...
  <Accordion title="Sell drinks only in packs of 6">
  ...
  <Accordion title="Cap each variant separately (sizes, colors)">
  ...
  <Accordion title="Limit everything except gift cards">
