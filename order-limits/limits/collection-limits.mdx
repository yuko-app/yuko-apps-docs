...
<AccordionGroup>
  <Accordion title="Minimum 3 items from the Sample Packs collection">
  ...
  <Accordion title="Cap Sale items at 5 per order">
  ...
  <Accordion title="Pre-orders limited to $500 per order">
  ...
  <Accordion title="Every product from the Bulk collection in packs of 12">
