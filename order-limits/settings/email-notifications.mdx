...
The **Customers Email** tab (in **Settings**) lets you send an automatic
email to customers whose order attempt exceeded a limit — for example, to
start a conversation about bulk pricing when someone tries to order above
your maximum.
